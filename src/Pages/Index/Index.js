...
export default function Index() {
    ...
    function findRecipes() {
        ...
        setErrorMessage('')
        setRecipes([])
        fetch(`https://forkify-api.herokuapp.com/api/v2/recipes?search=${searchedFood}&key=${key}`)
            .then(res => res.json())
            .then(foodData => {
    ...
    return (
        <div className="container">
            <div className='food-plaza'>
                <div className='food-plaza-header'>
                    <div className='food-plaza-header-left'>
                        ...
                        <div className='search-food'>
                            <input type='text' placeholder='what you want to cook...'
                                value={searchedFood}
                    ...
                    <div className='food-plaza-header-right'>
                        <div className='addRecipe' onClick={() => setShowAddRecipeModal(true)}>
                                    ...
                                    <ul className='bookmarks-list'>
                                        {
                                            allBookmarks.map(bookmarkedRecipe => (
                                                <div className='bookmark'>
                                                    ...
                                                    <DeleteIcon className='deleteBookmarkIcon' onClick={() => deleteBookmark(bookmarkedRecipe.id)} />
                                                </div>
                                            ))
                                        }
                                    </ul>
                ...
                <div className='row recipe-content-container'>
                    <div className='col-4 recipes-list-section'>
                        ...
                        {
                            recipes.length > 0 ? (<FoodRecipes recipes={recipes} />) : (
                                <>
                                    {
                    ...
                    <div className='col-8 recipe-info-section'>
                        {
                            <MainFoodRecipe bookmarks={allBookmarks} setAllBookmarks={setAllBookmarks} />
                        }
                    </div>
                </div>
            </div>
            {
                showAddRecipeModal && (
                    <AddRecipeModal showAddRecipeModal={showAddRecipeModal} setShowAddRecipeModal={setShowAddRecipeModal} />
                )
            }
        </div >
    )
